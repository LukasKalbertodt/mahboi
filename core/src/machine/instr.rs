...
pub const INSTRUCTIONS: InstrDb<Option<Instr>> = InstrDb([
    /* 00 */ Instr::some(0x00, "NOP",          1,  4,  None),
    /* 01 */ Instr::some(0x01, "LD BC, d16",   3, 12,  None),
    /* 02 */ Instr::some(0x02, "LD (BC), A",   1,  8,  None),
    /* 03 */ Instr::some(0x03, "INC BC",       1,  8,  None),
    /* 04 */ Instr::some(0x04, "INC B",        1,  4,  None),
    /* 05 */ Instr::some(0x05, "DEC B",        1,  4,  None),
    /* 06 */ Instr::some(0x06, "LD B, d8",     2,  8,  None),
    /* 07 */ Instr::some(0x07, "RLCA",         1,  4,  None),
    /* 08 */ Instr::some(0x08, "LD (a16), SP", 3,  20, None),
    /* 09 */ Instr::some(0x09, "ADD HL, BC",   1,  8,  None),
    /* 0a */ Instr::some(0x0a, "LD A, (BC)",   1,  8,  None),
    /* 0b */ Instr::some(0x0b, "DEC BC",       1,  8,  None),
    /* 0c */ Instr::some(0x0c, "INC C",        1,  4,  None),
    /* 0d */ Instr::some(0x0d, "DEC C",        1,  4,  None),
    /* 0e */ Instr::some(0x0e, "LD C, d8",     2,  8,  None),
    /* 0f */ Instr::some(0x0f, "RRCA",         1,  4,  None),

    /* 10 */ Instr::some(0x10, "STOP 0",       2,  4,  None),
    /* 11 */ Instr::some(0x11, "LD DE, d16",   3, 12,  None),
    /* 12 */ Instr::some(0x12, "LD (DE), A",   1,  8,  None),
    /* 13 */ Instr::some(0x13, "INC DE",       1,  8,  None),
    /* 14 */ Instr::some(0x14, "INC D",        1,  4,  None),
    /* 15 */ Instr::some(0x15, "DEC D",        1,  4,  None),
    /* 16 */ Instr::some(0x16, "LD D, d8",     2,  8,  None),
    /* 17 */ Instr::some(0x17, "RLA",          1,  4,  None),
    /* 18 */ Instr::some(0x18, "JR r8",        2, 12,  None),
    /* 19 */ Instr::some(0x19, "ADD HL, DE",   1,  8,  None),
    /* 1a */ Instr::some(0x1a, "LD A, (DE)",   1,  8,  None),
    /* 1b */ Instr::some(0x1b, "DEC DE",       1,  8,  None),
    /* 1c */ Instr::some(0x1c, "INC E",        1,  4,  None),
    /* 1d */ Instr::some(0x1d, "DEC E",        1,  4,  None),
    /* 1e */ Instr::some(0x1e, "LD E, d8",     2,  8,  None),
    /* 1f */ Instr::some(0x1f, "RRA",          1,  4,  None),

    /* 20 */ Instr::some(0x20, "JR NZ, r8",    2,  8,  Some(12)),
    /* 21 */ Instr::some(0x21, "LD HL, d16",   3,  12, None),
    /* 22 */ Instr::some(0x22, "LD (HL+), A",  1,  8,  None),
    /* 23 */ Instr::some(0x23, "INC HL",       1,  8,  None),
    /* 24 */ Instr::some(0x24, "INC H",        1,  4,  None),
    /* 25 */ Instr::some(0x25, "DEC H",        1,  4,  None),
    /* 26 */ Instr::some(0x26, "LD H, d8",     2,  8,  None),
    /* 27 */ Instr::some(0x27, "DAA",          1,  4,  None),
    /* 28 */ Instr::some(0x28, "JR Z, r8",     2,  8,  Some(12)),
    /* 29 */ Instr::some(0x29, "ADD HL, HL",   1,  8,  None),
    /* 2a */ Instr::some(0x2a, "LD A, (HL+)",  1,  8,  None),
    /* 2b */ Instr::some(0x2b, "DEC HL",       1,  8,  None),
    /* 2c */ Instr::some(0x2c, "INC L",        1,  4,  None),
    /* 2d */ Instr::some(0x2d, "DEC L",        1,  4,  None),
    /* 2e */ Instr::some(0x2e, "LD L, d8",     2,  8,  None),
    /* 2f */ Instr::some(0x2f, "CPL",          1,  4,  None),

    /* 30 */ Instr::some(0x30, "JR NC, r8",    2,  8,  Some(12)),
    /* 31 */ Instr::some(0x31, "LD SP, d16",   3,  12, None),
    /* 32 */ Instr::some(0x32, "LD (HL-), A",  1,  8,  None),
    /* 33 */ Instr::some(0x33, "INC SP",       1,  8,  None),
    /* 34 */ Instr::some(0x34, "INC (HL)",     1,  12, None),
    /* 35 */ Instr::some(0x35, "DEC (HL)",     1,  12, None),
    /* 36 */ Instr::some(0x36, "LD (HL), d8",  2,  12, None),
    /* 37 */ Instr::some(0x37, "SCF",          1,  4,  None),
    /* 38 */ Instr::some(0x38, "JR C, r8",     2,  8,  Some(12)),
    /* 39 */ Instr::some(0x39, "ADD HL, SP",   1,  8,  None),
    /* 3a */ Instr::some(0x3a, "LD A, (HL-)",  1,  8,  None),
    /* 3b */ Instr::some(0x3b, "DEC SP",       1,  8,  None),
    /* 3c */ Instr::some(0x3c, "INC A",        1,  4,  None),
    /* 3d */ Instr::some(0x3d, "DEC A",        1,  4,  None),
    /* 3e */ Instr::some(0x3e, "LD A, d8",     2,  8,  None),
    /* 3f */ Instr::some(0x3f, "CCF",          1,  4,  None),

    /* 40 */ Instr::some(0x40, "LD B, B",      1,  4,  None),
    /* 41 */ Instr::some(0x41, "LD B, C",      1,  4,  None),
    /* 42 */ Instr::some(0x42, "LD B, D",      1,  4,  None),
    /* 43 */ Instr::some(0x43, "LD B, E",      1,  4,  None),
    /* 44 */ Instr::some(0x44, "LD B, H",      1,  4,  None),
    /* 45 */ Instr::some(0x45, "LD B, L",      1,  4,  None),
    /* 46 */ Instr::some(0x46, "LD B, (HL)",   1,  8,  None),
    /* 47 */ Instr::some(0x47, "LD B, A",      1,  4,  None),
    /* 48 */ Instr::some(0x48, "LD C, B",      1,  4,  None),
    /* 49 */ Instr::some(0x49, "LD C, C",      1,  4,  None),
    /* 4a */ Instr::some(0x4a, "LD C, D",      1,  4,  None),
    /* 4b */ Instr::some(0x4b, "LD C, E",      1,  4,  None),
    /* 4c */ Instr::some(0x4c, "LD C, H",      1,  4,  None),
    /* 4d */ Instr::some(0x4d, "LD C, L",      1,  4,  None),
    /* 4e */ Instr::some(0x4e, "LD C, (HL)",   1,  8,  None),
    /* 4f */ Instr::some(0x4f, "LD C, A",      1,  4,  None),

    /* 50 */ Instr::some(0x50, "LD D, B",      1,  4,  None),
    /* 51 */ Instr::some(0x51, "LD D, C",      1,  4,  None),
    /* 52 */ Instr::some(0x52, "LD D, D",      1,  4,  None),
    /* 53 */ Instr::some(0x53, "LD D, E",      1,  4,  None),
    /* 54 */ Instr::some(0x54, "LD D, H",      1,  4,  None),
    /* 55 */ Instr::some(0x55, "LD D, L",      1,  4,  None),
    /* 56 */ Instr::some(0x56, "LD D, (HL)",   1,  8,  None),
    /* 57 */ Instr::some(0x57, "LD D, A",      1,  4,  None),
    /* 58 */ Instr::some(0x58, "LD E, B",      1,  4,  None),
    /* 59 */ Instr::some(0x59, "LD E, C",      1,  4,  None),
    /* 5a */ Instr::some(0x5a, "LD E, D",      1,  4,  None),
    /* 5b */ Instr::some(0x5b, "LD E, E",      1,  4,  None),
    /* 5c */ Instr::some(0x5c, "LD E, H",      1,  4,  None),
    /* 5d */ Instr::some(0x5d, "LD E, L",      1,  4,  None),
    /* 5e */ Instr::some(0x5e, "LD E, (HL)",   1,  8,  None),
    /* 5f */ Instr::some(0x5f, "LD E, A",      1,  4,  None),

    /* 60 */ Instr::some(0x60, "LD H, B",      1,  4,  None),
    /* 61 */ Instr::some(0x61, "LD H, C",      1,  4,  None),
    /* 62 */ Instr::some(0x62, "LD H, D",      1,  4,  None),
    /* 63 */ Instr::some(0x63, "LD H, E",      1,  4,  None),
    /* 64 */ Instr::some(0x64, "LD H, H",      1,  4,  None),
    /* 65 */ Instr::some(0x65, "LD H, L",      1,  4,  None),
    /* 66 */ Instr::some(0x66, "LD H, (HL)",   1,  8,  None),
    /* 67 */ Instr::some(0x67, "LD H, A",      1,  4,  None),
    /* 68 */ Instr::some(0x68, "LD L, B",      1,  4,  None),
    /* 69 */ Instr::some(0x69, "LD L, C",      1,  4,  None),
    /* 6a */ Instr::some(0x6a, "LD L, D",      1,  4,  None),
    /* 6b */ Instr::some(0x6b, "LD L, E",      1,  4,  None),
    /* 6c */ Instr::some(0x6c, "LD L, H",      1,  4,  None),
    /* 6d */ Instr::some(0x6d, "LD L, L",      1,  4,  None),
    /* 6e */ Instr::some(0x6e, "LD L, (HL)",   1,  8,  None),
    /* 6f */ Instr::some(0x6f, "LD L, A",      1,  4,  None),

    /* 70 */ Instr::some(0x70, "LD (HL), B",   1,  8,  None),
    /* 71 */ Instr::some(0x71, "LD (HL), C",   1,  8,  None),
    /* 72 */ Instr::some(0x72, "LD (HL), D",   1,  8,  None),
    /* 73 */ Instr::some(0x73, "LD (HL), E",   1,  8,  None),
    /* 74 */ Instr::some(0x74, "LD (HL), H",   1,  8,  None),
    /* 75 */ Instr::some(0x75, "LD (HL), L",   1,  8,  None),
    /* 76 */ Instr::some(0x76, "HALT",         1,  4,  None),
    /* 77 */ Instr::some(0x77, "LD (HL), A",   1,  8,  None),
    /* 78 */ Instr::some(0x78, "LD A, B",      1,  4,  None),
    /* 79 */ Instr::some(0x79, "LD A, C",      1,  4,  None),
    /* 7a */ Instr::some(0x7a, "LD A, D",      1,  4,  None),
    /* 7b */ Instr::some(0x7b, "LD A, E",      1,  4,  None),
    /* 7c */ Instr::some(0x7c, "LD A, H",      1,  4,  None),
    /* 7d */ Instr::some(0x7d, "LD A, L",      1,  4,  None),
    /* 7e */ Instr::some(0x7e, "LD A, (HL)",   1,  8,  None),
    /* 7f */ Instr::some(0x7f, "LD A, A",      1,  4,  None),

    /* 80 */ Instr::some(0x80, "ADD A, B",     1,  4,  None),
    /* 81 */ Instr::some(0x81, "ADD A, C",     1,  4,  None),
    /* 82 */ Instr::some(0x82, "ADD A, D",     1,  4,  None),
    /* 83 */ Instr::some(0x83, "ADD A, E",     1,  4,  None),
    /* 84 */ Instr::some(0x84, "ADD A, H",     1,  4,  None),
    /* 85 */ Instr::some(0x85, "ADD A, L",     1,  4,  None),
    /* 86 */ Instr::some(0x86, "ADD A, (HL)",  1,  8,  None),
    /* 87 */ Instr::some(0x87, "ADD A, A",     1,  4,  None),
    /* 88 */ Instr::some(0x88, "ADC A, B",     1,  4,  None),
    /* 89 */ Instr::some(0x89, "ADC A, C",     1,  4,  None),
    /* 8a */ Instr::some(0x8a, "ADC A, D",     1,  4,  None),
    /* 8b */ Instr::some(0x8b, "ADC A, E",     1,  4,  None),
    /* 8c */ Instr::some(0x8c, "ADC A, H",     1,  4,  None),
    /* 8d */ Instr::some(0x8d, "ADC A, L",     1,  4,  None),
    /* 8e */ Instr::some(0x8e, "ADC A, (HL)",  1,  8,  None),
    /* 8f */ Instr::some(0x8f, "ADC A, A",     1,  4,  None),

    /* 90 */ Instr::some(0x90, "SUB B",        1,  4,  None),
    /* 91 */ Instr::some(0x91, "SUB C",        1,  4,  None),
    /* 92 */ Instr::some(0x92, "SUB D",        1,  4,  None),
    /* 93 */ Instr::some(0x93, "SUB E",        1,  4,  None),
    /* 94 */ Instr::some(0x94, "SUB H",        1,  4,  None),
    /* 95 */ Instr::some(0x95, "SUB L",        1,  4,  None),
    /* 96 */ Instr::some(0x96, "SUB (HL)",     1,  8,  None),
    /* 97 */ Instr::some(0x97, "SUB A",        1,  4,  None),
    /* 98 */ Instr::some(0x98, "SBC A, B",     1,  4,  None),
    /* 99 */ Instr::some(0x99, "SBC A, C",     1,  4,  None),
    /* 9a */ Instr::some(0x9a, "SBC A, D",     1,  4,  None),
    /* 9b */ Instr::some(0x9b, "SBC A, E",     1,  4,  None),
    /* 9c */ Instr::some(0x9c, "SBC A, H",     1,  4,  None),
    /* 9d */ Instr::some(0x9d, "SBC A, L",     1,  4,  None),
    /* 9e */ Instr::some(0x9e, "SBC A, (HL)",  1,  8,  None),
    /* 9f */ Instr::some(0x9f, "SBC A, A",     1,  4,  None),

    /* a0 */ Instr::some(0xa0, "AND B",        1,  4,  None),
    /* a1 */ Instr::some(0xa1, "AND C",        1,  4,  None),
    /* a2 */ Instr::some(0xa2, "AND D",        1,  4,  None),
    /* a3 */ Instr::some(0xa3, "AND E",        1,  4,  None),
    /* a4 */ Instr::some(0xa4, "AND H",        1,  4,  None),
    /* a5 */ Instr::some(0xa5, "AND L",        1,  4,  None),
    /* a6 */ Instr::some(0xa6, "AND (HL)",     1,  8,  None),
    /* a7 */ Instr::some(0xa7, "AND A",        1,  4,  None),
    /* a8 */ Instr::some(0xa8, "XOR B",        1,  4,  None),
    /* a9 */ Instr::some(0xa9, "XOR C",        1,  4,  None),
    /* aa */ Instr::some(0xaa, "XOR D",        1,  4,  None),
    /* ab */ Instr::some(0xab, "XOR E",        1,  4,  None),
    /* ac */ Instr::some(0xac, "XOR H",        1,  4,  None),
    /* ad */ Instr::some(0xad, "XOR L",        1,  4,  None),
    /* ae */ Instr::some(0xae, "XOR (HL)",     1,  8,  None),
    /* af */ Instr::some(0xaf, "XOR A",        1,  4,  None),

    /* b0 */ Instr::some(0xb0, "OR B",         1,  4,  None),
    /* b1 */ Instr::some(0xb1, "OR C",         1,  4,  None),
    /* b2 */ Instr::some(0xb2, "OR D",         1,  4,  None),
    /* b3 */ Instr::some(0xb3, "OR E",         1,  4,  None),
    /* b4 */ Instr::some(0xb4, "OR H",         1,  4,  None),
    /* b5 */ Instr::some(0xb5, "OR L",         1,  4,  None),
    /* b6 */ Instr::some(0xb6, "OR (HL)",      1,  8,  None),
    /* b7 */ Instr::some(0xb7, "OR A",         1,  4,  None),
    /* b8 */ Instr::some(0xb8, "CP B",         1,  4,  None),
    /* b9 */ Instr::some(0xb9, "CP C",         1,  4,  None),
    /* ba */ Instr::some(0xba, "CP D",         1,  4,  None),
    /* bb */ Instr::some(0xbb, "CP E",         1,  4,  None),
    /* bc */ Instr::some(0xbc, "CP H",         1,  4,  None),
    /* bd */ Instr::some(0xbd, "CP L",         1,  4,  None),
    /* be */ Instr::some(0xbe, "CP (HL)",      1,  8,  None),
    /* bf */ Instr::some(0xbf, "CP A",         1,  4,  None),

    /* c0 */ Instr::some(0xc0, "RET NZ",       1,  8,  Some(20)),
    /* c1 */ Instr::some(0xc1, "POP BC",       1,  12, None),
    /* c2 */ Instr::some(0xc2, "JP NZ, a16",   3,  12, Some(16)),
    /* c3 */ Instr::some(0xc3, "JP a16",       3,  16, None),
    /* c4 */ Instr::some(0xc4, "CALL NZ, a16", 3,  12, Some(24)),
    /* c5 */ Instr::some(0xc5, "PUSH BC",      1,  16, None),
    /* c6 */ Instr::some(0xc6, "ADD A, d8",    2,  8,  None),
    /* c7 */ Instr::some(0xc7, "RST 00H",      1,  16, None),
    /* c8 */ Instr::some(0xc8, "RET Z",        1,  8,  Some(20)),
    /* c9 */ Instr::some(0xc9, "RET",          1,  16, None),
    /* ca */ Instr::some(0xca, "JP Z, a16",    3,  12, Some(16)),
    /* cb */ Instr::some(0xcb, "PREFIX CB",    0,  0,  None),
    /* cc */ Instr::some(0xcc, "CALL Z, a16",  3,  12, Some(24)),
    /* cd */ Instr::some(0xcd, "CALL a16",     3,  24, None),
    /* ce */ Instr::some(0xce, "ADC A, d8",    2,  8,  None),
    /* cf */ Instr::some(0xcf, "RST 08H",      1,  16, None),

    /* d0 */ Instr::some(0xd0, "RET NC",       1,  8,  Some(20)),
    /* d1 */ Instr::some(0xd1, "POP DE",       1,  12, None),
    /* d2 */ Instr::some(0xd2, "JP NC, a16",   3,  12, Some(16)),
    /* d3 */ None,
    /* d4 */ Instr::some(0xd4, "CALL NC, a16", 3,  12, Some(24)),
    /* d5 */ Instr::some(0xd5, "PUSH DE",      1,  16, None),
    /* d6 */ Instr::some(0xd6, "SUB d8",       2,  8,  None),
    /* d7 */ Instr::some(0xd7, "RST 10H",      1,  16, None),
    /* d8 */ Instr::some(0xd8, "RET C",        1,  8,  Some(20)),
    /* d9 */ Instr::some(0xd9, "RETI",         1,  16, None),
    /* da */ Instr::some(0xda, "JP C, a16",    3,  12, Some(16)),
    /* db */ None,
    /* dc */ Instr::some(0xdc, "CALL C, a16",  3,  12, Some(24)),
    /* dd */ None,
    /* de */ Instr::some(0xde, "SBC A, d8",    2,  8,  None),
    /* df */ Instr::some(0xdf, "RST 18H",      1,  16, None),

    /* e0 */ Instr::some(0xe0, "LDH (a8), A",  2,  12, None),
    /* e1 */ Instr::some(0xe1, "POP HL",       1,  12, None),
    /* e2 */ Instr::some(0xe2, "LD (C), A",    2,  8,  None),
    /* e3 */ None,
    /* e4 */ None,
    /* e5 */ Instr::some(0xe5, "PUSH HL",      1,  16, None),
    /* e6 */ Instr::some(0xe6, "AND d8",       2,  8,  None),
    /* e7 */ Instr::some(0xe7, "RST 20H",      1,  16, None),
    /* e8 */ Instr::some(0xe8, "ADD SP, r8",   2,  16, None),
    /* e9 */ Instr::some(0xe9, "JP (HL)",      1,  4,  None),
    /* ea */ Instr::some(0xea, "LD (a16), A",  3,  16, None),
    /* eb */ None,
    /* ec */ None,
    /* ed */ None,
    /* ee */ Instr::some(0xee, "XOR d8",       2,  8,  None),
    /* ef */ Instr::some(0xef, "RST 28H",      1,  16, None),

    /* f0 */ Instr::some(0xf0, "LDH A, (a8)",  2,  12, None),
    /* f1 */ Instr::some(0xf1, "POP AF",       1,  12, None),
    /* f2 */ Instr::some(0xf2, "LD A, (C)",    2,  8,  None),
    /* f3 */ Instr::some(0xf3, "DI",           1,  4,  None),
    /* f4 */ None,
    /* f5 */ Instr::some(0xf5, "PUSH AF",      1,  16, None),
    /* f6 */ Instr::some(0xf6, "OR d8",        2,  8,  None),
    /* f7 */ Instr::some(0xf7, "RST 30H",      1,  16, None),
    /* f8 */ Instr::some(0xf8, "LD HL, SP+r8", 2,  12, None),
    /* f9 */ Instr::some(0xf9, "LD SP, HL",    1,  8,  None),
    /* fa */ Instr::some(0xfa, "LD A, (a16)",  3,  16, None),
    /* fb */ Instr::some(0xfb, "EI",           1,  4,  None),
    /* fc */ None,
    /* fd */ None,
    /* fe */ Instr::some(0xfe, "CP d8",        2,  8,  None),
    /* ff */ Instr::some(0xff, "RST 38H",      1,  16, None),
]);
